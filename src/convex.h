...
extern int convex_create_account(const convex_p, const convex_key_pair_p, address_t *);
...
extern int convex_send(convex_p, const char *,const convex_key_pair_p, address_t address);
extern int convex_transfer(convex_p, address_t, amount_t, convex_key_pair_p, address_t);
