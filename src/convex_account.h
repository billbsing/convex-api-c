...
extern convex_account_p convex_account_init_from_file(const char *, const char *);
extern int convex_account_close(convex_account_p);
extern int convex_account_export_to_file(convex_account_p, const char *, const char *);
extern int convex_account_export_to_text(convex_account_p, const char *, char *, long *);
extern const unsigned char *convex_account_get_raw_public_key(convex_account_p account);
